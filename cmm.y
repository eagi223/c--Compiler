...
%token _SYMB_15    //   /
%token _SYMB_16    //   do
%token _SYMB_17    //   double
%token _SYMB_18    //   else
%token _SYMB_19    //   for
%token _SYMB_20    //   if
%token _SYMB_21    //   int
%token _SYMB_22    //   return
%token _SYMB_23    //   while
...
Stm : Decl _SYMB_5 {  $$ = new SDecl($1); YY_RESULT_Stm_= $$; } 
  ...
  | _SYMB_23 _SYMB_0 Exp _SYMB_1 Stm {  $$ = new SWhile($3, $5); YY_RESULT_Stm_= $$; }
  | _SYMB_20 _SYMB_0 Exp _SYMB_1 Stm {  $$ = new SIf($3, $5); YY_RESULT_Stm_= $$; }
  | _SYMB_16 Stm _SYMB_23 _SYMB_0 Exp _SYMB_1 _SYMB_5 {  $$ = new SDo($2, $5); YY_RESULT_Stm_= $$; }
  | _SYMB_20 _SYMB_0 Exp _SYMB_1 Stm _SYMB_18 Stm {  $$ = new SIfElse($3, $5, $7); YY_RESULT_Stm_= $$; }
  | _SYMB_19 _SYMB_0 Exp _SYMB_5 Exp _SYMB_1 Stm {  $$ = new SFor2($3, $5, $7); YY_RESULT_Stm_= $$; }
  | _SYMB_19 _SYMB_0 Exp _SYMB_5 Exp _SYMB_5 Exp _SYMB_1 Stm {  $$ = new SFor3($3, $5, $7, $9); YY_RESULT_Stm_= $$; }
  | _SYMB_22 Exp _SYMB_5 {  $$ = new SReturn($2); YY_RESULT_Stm_= $$; }
;
...
;
Type : _SYMB_21 {  $$ = new TInt(); YY_RESULT_Type_= $$; } 
  | _SYMB_17 {  $$ = new TDouble(); YY_RESULT_Type_= $$; }
;
